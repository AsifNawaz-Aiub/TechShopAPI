...
namespace TechShopCFAPI.BuyingAgentAuthorizations
{
    public class LoginBuyingAgentAuthorization : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                if(buyingAgentRepository.BuyingAgnetLoginValidation(email,password))
                {
